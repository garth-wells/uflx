...
class AbstractEvaluatedReferenceBasisFunction(AbstractExpression):
...
class EvaluatedReferenceBasisFunction(AbstractEvaluatedReferenceBasisFunction):
    ...
    def __repr__(self):
        """Representation."""
        return f"EvaluatedReferenceBasisFunction({self._element!r}, {self._basis_index}, {self._point!r})"
...
class EvaluatedReferenceBasisFunctionDerivative(AbstractEvaluatedReferenceBasisFunction):
    """A derivative of a basis function evaluated at a point on the reference cell."""
    ...
    def __repr__(self):
        """Representation."""
        return (
            f"EvaluatedReferenceBasisFunctionDerivative({self._element!r}, {self._basis_index}, "
...
class AbstractEvaluatedPhysicalBasisFunction(AbstractExpression):
...
class EvaluatedPhysicalBasisFunctionDerivative(AbstractEvaluatedPhysicalBasisFunction):
    """A derivative of a basis function evaluated at a point on the physical cell."""
    ...
    def __repr__(self):
        """Representation."""
        return (
            f"EvaluatedPhysicalBasisFunctionDerivative({self._element!r}, {self._basis_index}, "
            f"{self._point!r}, {self._derivative})"
        )
